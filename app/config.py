    ...
    PATCH_NOTES = [
        {
            ...
            "date": "2025-11-16",
            "items": [
                "成形条件の入力欄を温度・充填・保圧・計量の4セクションに整理し、必要な項目をすべて記録できるようにしました",
                "最新の同号機データから成形条件を自動で読み込み、変更箇所だけ修正すればよいようにしました",
                "一覧画面とCSV出力でも新しい成形条件と変化点メモを確認できるようにしました",
            ],
        },
        {
            "version": "3.0.2",
            "date": "2025-11-15",
            "items": [
                "入力フォームに環境温度・湿度・材料ロットを追加し必須化",
                "生産数を基本情報セクションへ移動",
                "号機/機種切替で最新の成形条件を自動プリセット",
                "一覧とCSVにも環境情報・材料ロットを表示",
            ],
        },
        {
            "version": "3.0.1",
